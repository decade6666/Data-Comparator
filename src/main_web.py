...
WEB_RELOAD_ENV = "DATASET_COMPARATOR_DEV_RELOAD"
...
def _enable_dev_reload() -> bool:
    return os.environ.get(WEB_RELOAD_ENV, "").strip().lower() in ("1", "true")
